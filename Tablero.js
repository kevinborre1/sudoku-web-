class Tablero {
  ...
  esValido(fila, columna, numero) {
    return this.numeroValidoParaFila(fila, numero) && 
           this.numeroValidoParaColumna(columna, numero) && 
           this.numeroValidoEnSector(fila, columna, numero);
  }
